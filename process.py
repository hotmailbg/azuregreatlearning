...
hostname = 'mysqlserver160423.mysql.database.azure.com'
username = 'azureuser@mysqlserver160423.mysql.database.azure.com'
password = 'belcome@123'
database = 'testdb'

def main():
    connect_str = "DefaultEndpointsProtocol=https;AccountName=p2glpb;AccountKey=48qlbJtBtjDdDCQQwZU+V2IOWI+DzYXlaZXxxswPfx73A5nbMbPpEbacR9cIsRj+Lr9IGxa2+e+z+ASteatPqw==;EndpointSuffix=core.windows.net"
